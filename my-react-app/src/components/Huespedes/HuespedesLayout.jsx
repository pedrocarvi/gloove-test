// src/components/Huespedes/HuespedesLayout.jsx
import React from 'react';
import { Link } from 'react-router-dom';

const HuespedesLayout = ({ children }) => {
  return (
        ...
        <div className="mb-8">
          ...
          <nav>
            <ul className="space-y-4">
              ...
              <li><Link to="/reservation" className="text-gray-600">Proceso de Reserva</Link></li>
              <li><Link to="/chat" className="text-gray-600">Chat</Link></li>
              <li><Link to="/open-property" className="text-gray-600">Abrir Vivienda</Link></li>
              <li><Link to="/incidents" className="text-gray-600">Incidencias</Link></li>
      ...
      <div className="flex-1">
        <header className="bg-white shadow p-4 flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div>
              <div className="text-blue-600 font-bold">Huésped</div>
